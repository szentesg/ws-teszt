...
class EasyReadableDateGeneratorTest extends TestCase
{
    ...
    public function testGenerateWithTooBigSecondNumber(): void
    {
        // Test case where the DateInterval is null
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage('Second number is too big');

        $this->generator->generateFromSeconds(315574442401);
    }
}